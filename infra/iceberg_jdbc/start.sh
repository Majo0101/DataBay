...
echo "=========================================="
echo "  Starting Spark + PostgreSQL"
echo "=========================================="
...
spark.sql.catalog.lake.uri jdbc:postgresql://localhost:5432/hive_metastore
spark.sql.catalog.lake.jdbc.user hive
spark.sql.catalog.lake.jdbc.password hive
spark.sql.catalog.lake.warehouse file:///lakehouse/warehouse/
